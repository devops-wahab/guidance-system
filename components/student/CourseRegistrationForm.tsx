...
export function CourseRegistrationForm({
  ...
  const [selectedCourses, setSelectedCourses] = useState<string[]>(enrolledCourseIds);
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between rounded-lg border bg-card p-6 shadow-sm">
        <div className="flex flex-col gap-1">
            <span className="text-sm font-medium text-muted-foreground">Total Units Selected</span>
            <span className="text-2xl font-bold">{calculateTotalCredits()}</span>
        </div>
        <Button onClick={onSubmit} disabled={isPending || selectedCourses.length === 0}>
